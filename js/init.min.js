...
$(function() {
    ...
    if (totalSites > 0) {
        ...
        if (typeof isComment != "undefined" && isComment == 1) {
            $(".navLinkUpdate.commentClass").removeClass("active")
        }
    }
    siteSelector();
    siteSelector(1);
    $("#site_lists").prepend(bottomToolbarVar);
//    $("#bottom_toolbar").prepend('<div id="bottomToolBarSelector">' + bottomToolbarVar + "</div>");
    ...
    if (toolTipData.addSite != "true")
        $("#addWebsite").qtip({events: {hide: function(e, t) {
                    tempArray = {};
                    tempArray["requiredData"] = {};
                    valArray = {};
                    valArray["addSite"] = true;
                ...
                }}, id: "addWebsiteQtip", content: {text: " ", title: {text: "Add your WordPress sites here", button: true}}, position: {my: "bottom center", at: "top center", adjust: {y: -7}}, show: {event: false, ready: true}, hide: false, style: {classes: "ui-tooltip-shadow ui-tooltip-dark", tip: {corner: true, width: 10, height: 5}}});
    if (toolTipData.adminPopup != "true")
        $(".showFooterSelector").qtip({id: "adminPopupQtip", events: {hide: function(e, t) {
                    tempArray = {};
                    tempArray["requiredData"] = {};
                    valArray = {};
                    valArray["adminPopup"] = true;
                    tempArray["requiredData"]["updateUserhelp"] = valArray;
                    tempArray["requiredData"]["getUserHelp"] = 1;
                    doCall(ajaxCallPath, tempArray, "setTooltipData")
                }}, content: {text: " ", title: {text: "You can still access your other sites from here", button: true}}, position: {my: "bottom left", at: "top left", adjust: {y: -7, x: 20}}, show: {event: false}, hide: true, style: {classes: "ui-tooltip-shadow ui-tooltip-dark", tip: {corner: true, width: 10, height: 5}}});
    if (toolTipData.reloadStats != "true") {
        $("#reloadStats").qtip({events: {hide: function(e, t) {
                    tempArray = {};
                    tempArray["requiredData"] = {};
                    valArray = {};
                    valArray["reloadStats"] = true;
                    tempArray["requiredData"]["updateUserhelp"] = valArray;
                    tempArray["requiredData"]["getUserHelp"] = 1;
                    doCall(ajaxCallPath, tempArray, "setTooltipData")
                }}, id: "reloadStatsQtip", content: {text: " ", title: {text: "Fetch real time data from all websites", button: true}}, position: {my: "right center", at: "left center", adjust: {x: -6}}, show: {event: false, ready: true}, hide: false, style: {classes: "ui-tooltip-shadow ui-tooltip-dark", tip: {corner: true, width: 5, height: 8}}})
    }
    $(".valid_error").hide();
    updateCountRefresh();
    historyRefresh();
    ...
    $(".websites_view").live("click", function(e) {
        e.preventDefault();
    ...
    $(".themes_view").live("click", function(e) {
        e.preventDefault();
        resetFilterText("#mainUpdateCont");
        $(".updateTabs").hide();
    ...
    $(".plugins_view").live("click", function(e) {
        e.preventDefault();
        resetFilterText("#mainUpdateCont");
        $(".updateTabs").hide();
    ...
    $(".nano").live("mousewheel", function(e, t) {
        if (!$.browser.msie && $.browser.version != "8.0") {
            var n = this;
            if ($(".slider", n).css("top") == "0px" && t > 0)
                cancelEvent(e);
            var r = $(this).height() - $(".slider", n).height();
            var r = r + "px";
            if ($(".slider", n).css("top") == r && t < 0)
                cancelEvent(e)
        }
    });
    $(".input_type_filter").live("focus", function() {
        if (this.value == "type to filter" || this.value == "new group" || this.value == "eg. group1, group2") {
            this.value = "";
            this.style.color = "#676C70"
        } else {
            this.style.color = "#676C70";
            this.select()
        }
    ...
    $(".input_type_filter").live("blur", function() {
        if (this.value == "") {
            ...
            else if ($(this).attr("id") == "groupText")
                this.value = "eg. group1, group2";
            else
    ...
    $("#save_group_changes").live("click", function() {
        ...
        if (e == true) {
            ...
            var n = {};
            t["requiredData"] = {};
            n["new"] = groupCreateArray;
            n["updateSites"] = groupChangeArray;
            n["updateNames"] = groupNameArray;
            n["delete"] = groupDeleteArray;
            t["requiredData"]["manageGroups"] = n;
            t["requiredData"]["getGroupsSites"] = 1;
            t["requiredData"]["getSites"] = 1;
            t["requiredData"]["getSitesList"] = 1;
            doCall(ajaxCallPath, t, "processSaveChange", "json")
        } else {
            $(".emptyError").remove();
...
//    });
    ...
    $(".fetchInstall").live("click", function() {
        if (!$(this).hasClass("disabled")) {
            ...
            var t = {};
            e["args"] = {};
            e["action"] = "get" + activeItem.toTitleCase();
            e["args"]["siteIDs"] = siteArray;
            t["getSearchedPluginsThemes"] = 1;
            e["requiredData"] = t;
            doCall(ajaxCallPath, e, "formArrayLoadPlugins", "json", "none")
        }
    });
    $(".actionButton").live("click", function() {
        applyChangesCheck("applyChangesCheck", 2)
    });
    ...
    $(".searchItem").live("click", function() {
        ...
        t["type"] = activeItem;
        t["searchVar"] = 1;
        t["searchItem"] = $(".searchText").val();
        e["requiredData"]["getWPRepositoryHTML"] = t;
        doCall(ajaxCallPath, e, "ajaxRepositoryCall", "json", "none")
    });
    ...
    $(".installNotInstalled").live("click", function() {
        ...
        var t = {};
        t["type"] = activeItem;
        t["siteID"] = notInstalledSiteID;
        t["plugin_slug"] = $(this).attr("plugin_theme_slug");
        e["requiredData"]["installNotInstalledPlugin"] = t;
        doCall(ajaxCallPath, e, "installNotInstallCallback", "json", "none")
    });
    ...
    $(".manage").live("click", function() {
        ...
        $(".optionsContent").html('<div style="padding:10px 0;"> <div class="btn_action pull-right fetchInstallCont"><a class="rep_sprite fetchInstall  btn btn-primary btn-small m-t-10">Load <span class="itemName">' + activeItem.toTitleCase() + ' </span></a></div> <div class="pull-right" style="margin-right:10px"> <input name="" type="text" onenterbtn=".fetchInstall" class="fetchInstallTxt txt onEnter" style="width: 300px; height: 17px; margin: 5px;" /> </div> <div class="pull-right" style="text-align:right; color:#737987; padding-top: 10px;"><span class="droid700" style="font-size:11px;">SEARCH <span class="itemName itemUpper">' + activeItem.toUpperCase() + '</span><br /> Leave blank to load all <span class="itemName">' + activeItem + '</span></div> <div class="clear-both"></div><div class="actionContent siteSearch" style="display:none;margin-top:10px "></div> </div>');
    ...
    $(".deleteGroup").live("click", function() {
        ...
        if ($(this).hasClass("yes")) {
            groupDeleteArray[$(e).attr("gid")] = $(e).attr("gid");
            $(".js_sites", "#bottom_sites_cont").removeClass("active");
            $(".ind_groups", "#bottom_sites_cont").removeClass("active");
            groupChangeArray[$(e).attr("gid")] = groupNameArray[$(e).attr("gid")] = groupCreateArray[$(e).attr("gid")] = "";
            $(e).fadeOut();
            $("#save_group_changes").show();
    ...
    $(".addSiteButton").live("click", function() {
        ...
        n["args"] = {};
        n["args"]["params"] = {};
        var r = $("#adminURL", "#modalDiv").val();
        var i = $("#username", ".add_site.form_cont").val();
        var s = $("#groupText", ".add_site.form_cont").val();
        var o = $("#activationKey", ".add_site.form_cont").val();
        var u = $(".connectURLClass.active", ".add_site.form_cont").attr("def");
        if ($(".cTypeRadio.active").hasClass("customTxt")) {
            ...
            if ($(".cTypeRadio.active").text() == "application/x-www-form-urlencoded")
                ...
                t = $(".cTypeRadio.active").text()
        }
        if (s == "eg. group1, group2") {
            s = ""
        }
        var a = groupSelected();
        if (e != 1) {
            n["action"] = "addSite";
            n["args"]["params"]["URL"] = r;
            n["args"]["params"]["activationKey"] = o;
            n["args"]["params"]["username"] = i;
            n["args"]["params"]["groupsPlainText"] = s;
            n["args"]["params"]["groupIDs"] = a;
            n["args"]["params"]["callOpt"] = {};
            if ($(this).hasClass("advanced")) {
                n["args"]["params"]["callOpt"]["contentType"] = t;
                n["args"]["params"]["connectURL"] = u;
                n["args"]["params"]["advancedCUCT"] = 0
            } else {
                n["args"]["params"]["callOpt"]["contentType"] = "";
                n["args"]["params"]["connectURL"] = "default";
                n["args"]["params"]["advancedCUCT"] = 1
            }
            if ($("#addSiteAuthUsername").val() != "username") {
                n["args"]["params"]["httpAuth"] = {};
                n["args"]["params"]["callOpt"] = {};
                n["args"]["params"]["httpAuth"]["username"] = $("#addSiteAuthUsername").val();
                n["args"]["params"]["httpAuth"]["password"] = $("#addSiteAuthUserPassword").val()
            }
        }
        n["requiredData"] = {};
        if (e == 1) {
            n["requiredData"]["updateSite"] = {};
            n["requiredData"]["updateSite"]["URL"] = $("#websiteURL", ".add_site.form_cont").val();
            n["requiredData"]["updateSite"]["siteID"] = $(this).attr("sid");
            n["requiredData"]["updateSite"]["adminURL"] = $("#adminURL", ".add_site.form_cont").val();
            n["requiredData"]["updateSite"]["groupsPlainText"] = s;
            n["requiredData"]["updateSite"]["groupIDs"] = a;
            n["requiredData"]["updateSite"]["adminUsername"] = i;
            n["requiredData"]["updateSite"]["connectURL"] = u;
            n["requiredData"]["updateSite"]["callOpt"] = {};
            n["requiredData"]["updateSite"]["callOpt"]["contentType"] = t;
            if ($("#addSiteAuthUsername").val() != "username") {
                n["requiredData"]["updateSite"]["httpAuth"] = {};
                n["requiredData"]["updateSite"]["httpAuth"]["username"] = $("#addSiteAuthUsername").val();
                n["requiredData"]["updateSite"]["httpAuth"]["password"] = $("#addSiteAuthUserPassword").val()
            }
        }
        n["requiredData"]["getSitesUpdates"] = 1;
        n["requiredData"]["getGroupsSites"] = 1;
        n["requiredData"]["getSites"] = 1;
        n["requiredData"]["getSitesList"] = 1;
        $(this).addClass("disabled");
        $(this).prepend('<div class="fa fa-spin fa-spinner btn_loadingDiv left"></div>');
        if (e == 1) {
            if (typeof isGoogle != "undefined" && isGoogle == 1) {
                n["requiredData"]["googleAnalyticsSetProfilesAndSites"] = {};
                n["requiredData"]["googleAnalyticsSetProfilesAndSites"]["googleProfileID"] = $("#gg option:selected").attr("profileID");
                n["requiredData"]["googleAnalyticsSetProfilesAndSites"]["siteID"] = $(this).attr("sid")
            }
            if (typeof isGoogleWM != "undefined" && isGoogleWM == 1) {
                n["requiredData"]["googleWebMastersSetProfilesAndSites"] = {};
                n["requiredData"]["googleWebMastersSetProfilesAndSites"]["googleProfileID"] = $("#ggwm option:selected").attr("profileID");
                n["requiredData"]["googleWebMastersSetProfilesAndSites"]["siteID"] = $(this).attr("sid")
            }
            doCall(ajaxCallPath, n, "processEditSite", "json", "none")
        } else
            doCall(ajaxCallPath, n, "processAddSite", "json", "none")
    });
    $(".js_addSite").live("click", function() {
        makeSelection(this)
    });
    $(".select2_bottom .select_group_toolbar").select2({width: "177px"});
    ...
    $(".installFromComputer").live("click", function() {
        ...
        if (settingsData.data.getSettingsAll.settings.general.httpAuth != undefined) {
            if (settingsData.data.getSettingsAll.settings.general.httpAuth.username != "")
                r = r.replace("://", "://" + settingsData.data.getSettingsAll.settings.general.httpAuth.username + ":" + settingsData.data.getSettingsAll.settings.general.httpAuth.password + "@")
        }
        $(".installFileNames").each(function() {
            var i = $(this).html().replace(/ /g, "%20");
            n = r + "uploads/" + i;
            t[e] = n;
            e++
        });
    ...
    $(".addToFavorites").live("click", function() {
        ...
        e["requiredData"] = {};
        var t = {};
        t["name"] = $(this).attr("iname");
        t["slug"] = $(this).attr("islug");
        t["URL"] = $(this).attr("dlink");
        t["type"] = $(this).attr("utype");
        e["requiredData"]["addFavourites"] = {};
        e["requiredData"]["addFavourites"] = t;
        e["requiredData"]["getFavourites"] = 1;
        doCall(ajaxCallPath, e, "reloadFavourites", "json")
    });
    $(".hideItem").live("click", function() {
        var e = $(this).closest(".item_ind");
        var t = {};
        t["requiredData"] = {};
        var n = {};
        if (currentUpdatePage == "siteViewUpdateContent")
            typeText = $(".row_" + $(e).attr("selector") + " .label").text();
        prevCount = parseInt($(".row_" + $(e).attr("selector") + " .count span").text());
        if ($(this).text() == "Hide") {
            ...
            $(".row_" + $(e).attr("selector") + " .count span").text(prevCount - 1);
        ...
        if (n["type"] == "WP")
            n["type"] = "core";
        t["requiredData"][tempAction] = {};
        t["requiredData"][tempAction][$(e).attr("sid")] = n;
        t["requiredData"]["getSitesUpdates"] = 1;
        doCall(ajaxCallPath, t, "processHideUpdate", "json");
    ...
    $(".qty_btn").live("click", function() {
        var e = $(this).closest(".qty_selector_cont");
        var t = $("input", e).attr("id");
        addNumber(this, t)
    });
    $("#backupNow").live("click", function() {
        var e = $(this).hasClass("scheduleBackup");
        ...
        var r = {};
        var i = ".create_backup";
        var s = $("#includeFolders", i).val();
        if ($("#compression", i).hasClass("active"))
            var o = 1;
        else
            var o = "";
        if ($("#databaseOptimize", i).hasClass("active"))
            var u = 1;
        else
            var u = "";
        var a = $("#excludeFiles", i).val();
        if (a == "eg. wp-admin, old-backup.zip")
            var a = "";
        var f = $("#excludeExtensions").val();
        if (a == "eg. .zip,.mp4")
            a = "";
        if ($("#full", i).hasClass("active"))
            var l = "full";
        else if ($("#files", i).hasClass("active"))
            var l = "files";
        else
            var l = "db";
        var c = $("#backupName", i).val();
        var h = $("#backupOptions #backupTotal").val();
        r["limit"] = h;
        r["mechanism"] = $(".backupMechanism.active").attr("mechanism");
        n["action"] = "backup";
        if (scheduleAddonFlag == 1) {
            if (e) {
                var p = $("#backupOptions .whenType.active").text().toLowerCase();
                r["type"] = p;
                var d = r["scheduleHR"] = $("#backupOptions #timeSelectBtn a").attr("timeval");
                if (p == "daily")
                    r["scheduleHR"] = d;
                else if (p == "weekly")
                    r["scheduleHR"] = d + "|" + $("#backupOptions .day_select_cont .optionSelect.active").attr("dayval");
                else if (p == "monthly")
                    r["scheduleHR"] = d + "|" + $("#backupOptions .date_select_cont .selectDate.active").text();
                if ($(this).attr("schedulekey") != undefined && $(this).attr("schedulekey") != "")
                    n["args"]["params"]["schedulekey"] = $(this).attr("schedulekey");
                n["action"] = "scheduleBackup"
            }
        }
        if (repositoryAddonFlag == 1) {
            if ($(this).hasClass("repoSubmit")) {
                var v = [$(".dialog_cont .repBtn.active").attr("repType")];
                if (v != "iwp_server") {
                    var m = validateForm($(".dialog_cont .repBtn.active").attr("rep") + "Repo");
                    if (m != false) {
                        n["args"]["params"]["accountInfo"] = {};
                        n["args"]["params"]["accountInfo"][v] = m;
                        r["delHostFile"] = 1
                    } else
                        return false
                } else {
        ...
        r["include"] = s;
        r["disableCompression"] = o;
        r["optimizeDB"] = u;
        r["exclude"] = a;
        r["what"] = l;
        r["backupName"] = c;
        if ($("#excludeSize").hasClass("active")) {
            r["excludeFileSize"] = $("#excludeSizesSelect").val()
        } else {
            r["excludeFileSize"] = 0
        }
        r["excludeExtensions"] = $("#excludeExtensions").val();
        if ($("#fail_safe_check_files").hasClass("active"))
            r["failSafeFiles"] = 1;
        if ($("#fail_safe_check_DB").hasClass("active"))
            r["failSafeDB"] = 1;
        n["args"]["params"]["config"] = r;
        if (!e)
            n["args"]["params"]["action"] = "now";
        if ($(t).hasClass("singleBackup")) {
            n["args"]["siteIDs"] = {};
            n["args"]["siteIDs"][0] = $("#siteIDForBackup").html()
        } else
            n["args"]["siteIDs"] = getSelectedSites(".dialog_cont");
        if (e) {
            var g = {};
            g = n["args"];
            n["requiredData"] = {};
            n["requiredData"]["scheduleBackupCreate"] = {};
            n["requiredData"]["scheduleBackupCreate"] = g;
            delete n.action;
            delete n.args;
            doCall(ajaxCallPath, n, "scheduleBackupResponse", "json")
        } else {
            doHistoryCall(ajaxCallPath, n, "")
        }
    ...
    $(".bottomSites").live("mouseenter", function() {
        ...
        if (groupEditFlag == 0) {
            ...
            if (bottomFullBar == 1)
                var t = e.top - ($(window).height() - 43);
            else
                var t = e.top - 392;
            $("#bottomToolbarOptions").css("top", t);
            var n = Math.max(document.documentElement.clientHeight, window.innerHeight || 0) - $("#bottom_toolbar").outerHeight();
            var r = $("#bottomToolbarOptions").offset().top + $("#bottomToolbarOptions").outerHeight() + 20;
            if (r > n) {
                $("#bottomToolbarOptions").css("top", t - r + n)
            }
        }
    }).live("mouseleave", function() {
        btActiveCheck = 0;
        setTimeout(function() {
            if (btCheckFlag == 0 && btActiveCheck == 0)
                $("#bottomToolbarOptions").remove()
        }, 50)
    });
    ...
    $("#viewBackups").live("click", function() {
        var e = {};
        e["requiredData"] = {};
        e["requiredData"]["getSiteBackupsHTML"] = $(this).attr("sid");
        doCall(ajaxCallPath, e, "loadBackupPopup", "json")
    });
    $(".removeBackup").live("click", function() {
        var e = $(this).closest(".item_ind");
        var t = $(e).closest(".topBackup");
        $(".delConfHide", e).hide();
        $(t).addClass("del")
    });
    ...
    $(".confirmAction").live("click", function() {
        ...
        if ($(tempConfirmObject).hasClass("restoreBackup")) {
            var e = {};
            e["args"] = {};
            e["action"] = "restoreBackup";
            e["args"]["params"] = {};
            e["args"]["params"]["taskName"] = "Backup Now";
            e["args"]["params"]["resultID"] = $(tempConfirmObject).attr("referencekey");
            e["args"]["siteIDs"] = [$(tempConfirmObject).attr("sid")];
            $(tempConfirmObject).addClass("disabled");
            $(tempConfirmObject).text("Queued..");
            doHistoryCall(ajaxCallPath, e, "");
            return false
        }
        tempConfirmObject = "";
        return false
    ...
    $(".refreshData").live("click", function() {
        var e = {};
        e["requiredData"] = {};
        e["requiredData"]["getHistoryPageHTML"] = {};
        e["requiredData"]["getHistoryPageHTML"]["dates"] = $("#dateContainer").text();
        e["requiredData"]["getHistoryPageHTML"]["page"] = 1;
        $("#dateContainer").attr("exactdate", $("#dateContainer").text());
        $("#widgetCalendar").height(0);
        state = !state;
        doCall(ajaxCallPath, e, "loadHistoryPageContent")
    });
    ...
    $(".delFavourites").live("click", function() {
        ...
        n["URL"] = $(e).attr("dlink");
        n["type"] = $(e).attr("utype");
        t["requiredData"]["removeFavourites"] = {};
        t["requiredData"]["removeFavourites"] = n;
        t["requiredData"]["getFavourites"] = 1;
        doCall(ajaxCallPath, t, "reloadFavourites", "json");
        $(this).closest(".favItems").fadeOut();
        return false
    }).live("mouseenter", function() {
        $(this).closest(".favItems").addClass("delWarn")
    }).live("mouseout", function() {
        $(this).closest(".favItems").removeClass("delWarn")
    });
    $("#reloadStats, .reloadSingleStats").live("click", function() {
        ...
        if ($(this).hasClass("reloadSingleStats")) {
            e["args"] = {};
            e["args"]["siteIDs"] = {};
            e["args"]["siteIDs"][0] = $(this).attr("sid");
            e["args"]["params"] = {};
            e["args"]["params"]["forceRefresh"] = 1;
            $("#reloadStats").addClass("disabled");
            $("#reloadStats").closest("div").addClass("disabled");
            $("#reloadStats").prepend('<div class="btn_loadingDiv"><div>')
        } else {
            $(this).addClass("disabled");
            $(this).closest("div").addClass("disabled");
            $(this).prepend('<div class="btn_loadingDiv right"><div>')
        }
        e["action"] = "getStats";
        e["requiredData"] = {};
        if (typeof isComment != "undefined") {
            e["requiredData"]["manageCommentsGetRecent"] = 1
        }
        if (typeof isGoogle != "undefined") {
            if (isGoogle == "1") {
                e["requiredData"]["googleAnalyticsEditSiteOptions"] = 1
            }
        }
        e["requiredData"]["getSitesUpdates"] = 1;
        e["requiredData"]["getClientUpdateAvailableSiteIDs"] = 1;
        e["requiredData"]["getRecentPluginsStatus"] = 1;
        e["requiredData"]["getRecentThemesStatus"] = 1;
        e["requiredData"]["getSites"] = 1;
        doCall(ajaxCallPath, e, "formArrayRefreshStats", "json", "none")
    });
    $(".settingsButtons").live("click", function() {
        $(".settingsItem").hide();
        var e = $(this).attr("item");
    ...
    $(".settings_nav li").live("click", function() {
        ...
        $(this).addClass("active");
        var e = getSpecificSettingsContent($(this).text());
        $(".settings_main_content").html(e);
    ...
    $("#googleSaveSettingsBtn").live("click", function() {
        ...
        if (e == "googleTab") {
            ...
            $("#clientCreds .formVal").each(function() {
                n[$(this).attr("id")] = $(this).val()
            });
            t["requiredData"]["googleServicesSaveAPIKeys"] = n;
            doCall(ajaxCallPath, t, "processSettingsUpdate")
        }
    });
    $("#saveSettingsBtn").live("click", function() {
        ...
        if (e == "settingsTab") {
            var t = $("#email").val();
            if (!echeck(t)) {
                var n = $("#email").closest(".valid_cont");
                $(".valid_error div", n).text("Invalid email. Kindly retry");
                $(".valid_error", n).show();
                ...
                if ($(".change_pass_cont").is(":visible")) {
                    ...
                    i["currentPassword"] = $("#currentPassword").val()
                }
                i["email"] = $("#email").val();
                r["requiredData"]["updateAccountSettings"] = i;
                r["requiredData"]["updateSettings"] = {};
                r["requiredData"]["updateSettings"]["notifications"] = {};
                r["requiredData"]["updateSettings"]["notifications"]["updatesNotificationMail"] = {};
                r["requiredData"]["updateSettings"]["notifications"]["updatesNotificationMail"]["frequency"] = $(".emailFrequency.active").attr("def");
                ...
                if ($("#notifyWordpress").hasClass("active"))
                    ...
                    notifyWordpress = 0;
                r["requiredData"]["updateSettings"]["notifications"]["updatesNotificationMail"]["coreUpdates"] = notifyWordpress;
                r["requiredData"]["updateSettings"]["notifications"]["updatesNotificationMail"]["pluginUpdates"] = notifyPlugins;
                r["requiredData"]["updateSettings"]["notifications"]["updatesNotificationMail"]["themeUpdates"] = notifyThemes;
                r["requiredData"]["getSettingsAll"] = 1;
                doCall(ajaxCallPath, r, "processSettingsUpdate", "json", "none")
            }
        } else if (e == "appSettingsTab") {
            var r = {};
            r["requiredData"] = {};
            r["requiredData"]["updateSettings"] = {};
            r["requiredData"]["getSettingsAll"] = 1;
            r["requiredData"]["updateSettings"]["general"] = {};
            ...
            if ($("#enableReloadDataPageLoad").hasClass("active"))
                ...
                var f = 0;
            var l = $("#timeZoneSelector").val();
            if (typeof l != "undefined" && l != "") {
                r["requiredData"]["updateSettings"]["general"]["TIMEZONE"] = l
            }
            r["requiredData"]["updateSettings"]["general"]["MAX_SIMULTANEOUS_REQUEST_PER_IP"] = $("#amount01").val();
            r["requiredData"]["updateSettings"]["general"]["MAX_SIMULTANEOUS_REQUEST"] = $("#amount02").val();
            r["requiredData"]["updateSettings"]["general"]["TIME_DELAY_BETWEEN_REQUEST_PER_IP"] = $("#amount03").val();
            r["requiredData"]["updateSettings"]["allowedLoginIPs"] = c;
            r["requiredData"]["updateSettings"]["allowedLoginIPsCount"] = h;
            r["requiredData"]["updateSettings"]["general"]["sendAnonymous"] = s;
            r["requiredData"]["updateSettings"]["general"]["executeUsingBrowser"] = u;
            r["requiredData"]["updateSettings"]["general"]["autoSelectConnectionMethod"] = a;
            r["requiredData"]["updateSettings"]["general"]["enableReloadDataPageLoad"] = f;
            r["requiredData"]["updateSettings"]["general"]["CONSIDER_3PART_IP_ON_SAME_SERVER"] = o;
            r["requiredData"]["getSettingsAll"] = 1;
            doCall(ajaxCallPath, r, "processSettingsUpdate", "json", "none")
        } else if (e == "securitySettingsTab") {
            var r = {};
            r["requiredData"] = {};
            r["requiredData"]["updateSecuritySettings"] = {};
            var c = {};
            var h = 0;
            $(".ip_cont", "#IPContent").each(function() {
                c[h] = $(".IPData", this).text();
                h++
            });
            if ($("#authUsername").val() != "username") {
                r["requiredData"]["updateSecuritySettings"]["httpAuth"] = {};
                r["requiredData"]["updateSecuritySettings"]["httpAuth"]["username"] = $("#authUsername").val();
                r["requiredData"]["updateSecuritySettings"]["httpAuth"]["password"] = $("#authPassword").val()
            }
            r["requiredData"]["updateSecuritySettings"]["allowedLoginIPs"] = c;
            r["requiredData"]["updateSecuritySettings"]["allowedLoginIPsCount"] = h;
            var p = 0;
            if ($("#enableHTTPS").hasClass("active")) {
                p = 1
            }
            r["requiredData"]["updateSecuritySettings"]["enableHTTPS"] = p;
            r["requiredData"]["getSettingsAll"] = 1;
            doCall(ajaxCallPath, r, "processSettingsUpdate")
        } else if (e == "uptimeTab") {
            var r = {};
            r["requiredData"] = {};
            var d = {};
            ...
            r["requiredData"]["uptimeMonitorUptimeRobotSaveApiKey"] = d;
            doCall(ajaxCallPath, r, "processUptimeAPIKeySave")
        } else if (e == "brandingTab") {
            var r = {};
            r["action"] = "clientPluginBranding";
            r["args"] = {};
            r["args"]["params"] = {};
            r["requiredData"] = {};
            if ($(".hideClientPlugin").hasClass("active")) {
                r["args"]["params"]["hide"] = 1
            } else {
                var d = {};
            ...
            r["requiredData"]["clientPluginBrandingGet"] = 1;
            doCall(ajaxCallPath, r, "processBranding", "json", "none")
        } else if (e == "ftpSettingsTab") {
            $FTP = {};
            ...
            var r = {};
            r["requiredData"] = {};
            r["requiredData"]["setFTPValues"] = $FTP;
            doCall(ajaxCallPath, r, "processSettingsUpdate")
        }
    });
    $(".participateInBetaCheck").live("click", function() {
        ...
        var t = {};
        t["requiredData"] = {};
        t["requiredData"]["updateSettingsMerge"] = {};
        t["requiredData"]["updateSettingsMerge"]["general"] = {};
        t["requiredData"]["updateSettingsMerge"]["general"]["participateBeta"] = e;
        doCall(ajaxCallPath, t, "", "json", "none")
    });
    ...
    $("#addIP").live("click", function() {
        ...
        var e = $("#tempIP").val();
        if (e != "")
            $("#IPContent").append('<div class="ip_cont"><span class="droid700 IPData">' + e + '</span><span class="remove removeIP" onclick="">remove</span></div>');
    ...
    $("#sendAnonymous, #executeUsingBrowser, #enableReloadDataPageLoad, #clearPluginCache, #ipRangeSame,.makeSelection").live("click", function() {
        makeSelection(this)
    });
    ...
    $(".deleteBackup").live("click", function() {
        var e = $(this).closest(".item_ind");
        var t = $(e).closest(".topBackup");
        var n = $(e).closest(".row_updatee");
        var r = $(this).closest(".row_backup_action");
        if ($(this).hasClass("scheduleDelete"))
            t = $(this).closest(".ind_row_cont");
        if ($(this).hasClass("yes")) {
            var i = {};
            i["args"] = {};
            i["action"] = "removeBackup";
            i["args"]["params"] = {};
            if ($(this).attr("schedulekey") != undefined && $(this).attr("schedulekey") != "")
                i["args"]["params"]["taskName"] = $(this).attr("schedulekey");
            else
                i["args"]["params"]["taskName"] = $(".trash.removeBackup", r).attr("taskname");
            i["args"]["params"]["resultID"] = $(".trash.removeBackup", r).attr("referencekey");
            i["args"]["siteIDs"] = [$(".trash.removeBackup", r).attr("sid")];
            $(t).remove();
            if ($(this).hasClass("scheduleDelete")) {
                i = {};
                i["args"] = {};
                i["args"]["params"] = {};
                i["action"] = "scheduleBackupDeleteTask";
                i["args"]["params"]["scheduleKey"] = $(this).attr("schedulekey")
            }
            if ($(this).attr("schedulekey") == undefined || $(this).attr("schedulekey") == "") {
                if ($(".row_updatee_ind", n).length == 0)
                    $($(n).closest(".ind_row_cont").remove())
            }
            doHistoryCall(ajaxCallPath, i, "")
        } else {
            if ($(this).hasClass("scheduleDelete")) {
                t = ".ind_row_cont .row_summary, .row_detailed";
                e = $(this).closest(".ind_row_cont")
            }
            $(t).removeClass("del");
            $(".delConfHide", e).show()
        }
    ...
    $(".editEmail").live("click", function() {
        ...
        $(".emailEdit", e).addClass("focus").focus()
    });
    ...
    $("#removeSiteConfirm").live("click", function(e) {
        ...
        t["args"]["siteIDs"] = {};
        t["action"] = "removeSite";
        t["args"]["params"]["iwpPluginDeactivate"] = 1;
        t["args"]["siteIDs"][0] = $(this).attr("sid");
        t["requiredData"]["getGroupsSites"] = 1;
        t["requiredData"]["getSites"] = 1;
        t["requiredData"]["getSitesList"] = 1;
        t["requiredData"]["getSitesUpdates"] = 1;
        ...
        doCall(ajaxCallPath, t, "processRemoveSite");
        return false
    });
    $("#readdSiteConfirm").live("click", function() {
        ...
        e["args"]["params"] = {};
        e["args"]["siteIDs"] = {};
        e["args"]["params"]["activationKey"] = $("#readdAuthKey").val();
        e["args"]["siteIDs"][0] = $(this).attr("sid");
        e["requiredData"] = {};
        e["requiredData"]["getReaddedSite"] = 1;
        doCall(ajaxCallPath, e, "processReaddSite", "json", "none")
    });
    $(".addSiteToggleAction").live("click", function(e) {
        ...
        if (!$(this).hasClass("active")) {
            if ($(this).hasClass("assignToggleAction")) {
                ...
                if (!$(".addSiteButton").hasClass("advanced"))
                    $(".addSiteButton").addClass("advanced")
    ...
    $("#enterBackupDetails").live("click", function() {
        ...
        $(".create_backup .completed").qtip({id: "backupToolTip", events: {show: function(e, t) {
                    if (!$("#selectWebsitesTab").hasClass("completed"))
                        return false
                }}, content: {text: "Edit"}, position: {my: "left center", at: "right center"}, show: {event: "mouseenter"}, hide: {event: "mouseleave"}, style: {classes: "ui-tooltip-shadow ui-tooltip-dark"}});
    ...
    $(".input_type_filter").live("focus", function() {
        if (this.value == "type to filter" || this.value == "new group") {
            this.value = "";
            this.style.color = "#676C70"
        } else {
            this.style.color = "#676C70";
    ...
    $(".sendReport").live("click", function() {
        var e = {};
        e["requiredData"] = {};
        e["requiredData"]["getReportIssueData"] = $(this).attr("actionid");
        doCall(ajaxCallPath, e, "loadReport", "json");
        $("#historyQueue").hide();
        return false
    });
    $(".moreInfo").live("click", function() {
        var e = {};
        e["requiredData"] = {};
        e["requiredData"]["getResponseMoreInfo"] = $(this).attr("historyid");
        doCall(ajaxCallPath, e, "loadMoreInfo", "json");
        $("#historyQueue").hide();
        return false
    });
    $("#sendReportBtn").live("click", function() {
        var e = {};
        e["requiredData"] = {};
        e["requiredData"]["sendReportIssue"] = {};
        e["requiredData"]["sendReportIssue"]["email"] = $("#emailToReport").val();
        if ($(this).attr("actiontype") == "historyIssue") {
            e["requiredData"]["sendReportIssue"]["report"] = $("#panelHistoryContent").val();
            e["requiredData"]["sendReportIssue"]["actionID"] = $("#panelHistoryActionID").val()
        }
        e["requiredData"]["sendReportIssue"]["comment"] = $("#customerComments").val();
        e["requiredData"]["sendReportIssue"]["appVersion"] = appVersion;
        e["requiredData"]["sendReportIssue"]["type"] = $(this).attr("actiontype");
        e["requiredData"]["sendReportIssue"]["appInstallHash"] = appInstallHash;
        if ($("#customerComments").val() != "") {
            $("#customerComments").removeClass("error");
            $(this).append('<div class="btn_loadingDiv left"></div>').addClass("disabled");
            doCall(ajaxCallPath, e, "processReport", "json", "noProgress")
        } else
    ...
    $("#sendTestEmail").live("click", function() {
        var e = {};
        e["requiredData"] = {};
        e["requiredData"]["updatesNotificationMailTest"] = 1;
    ...
    $("#updateNotifyClose").live("click", function() {
        var e = {};
        e["requiredData"] = {};
        e["requiredData"]["updateHideNotify"] = $(this).attr("version");
        doCall(ajaxCallPath, e, "", "json");
    ...
    $(".updateActionBtn").live("click", function() {
        ...
        if ($(this).attr("btnAction") == "check") {
            var e = {};
            e["requiredData"] = {};
            e["requiredData"]["forceCheckUpdate"] = 1;
            doCall(ajaxCallPath, e, "processCheckUpdate", "json");
            return false
    ...
    $("#updateClientConfirm").live("click", function() {
        var e = {};
        e["action"] = "updateClient";
        e["args"] = {};
        e["args"]["siteIDs"] = clientUpdateSites;
        doHistoryCall(ajaxCallPath, e, "", "json");
    ...
    $(".closeUpdateNotification").live("click", function() {
        ...
        tempArray["requiredData"] = {};
        valArray = {};
        valArray["closeUpdateNotification_2-3-0-beta-1"] = true;
        tempArray["requiredData"]["updateUserhelp"] = valArray;
        tempArray["requiredData"]["getUserHelp"] = 1;
        doCall(ajaxCallPath, tempArray, "setTooltipData")
    });
    ...
    $(".editSiteBtn").live("click", function() {
        ...
        if (getPropertyCount(site[$(this).attr("sid")].groupIDs) > 0) {
            $.each(site[$(this).attr("sid")].groupIDs, function(e, t) {
                $(".addSiteGroups .g" + t).addClass("active")
            })
        }
        if (site[$(this).attr("sid")].callOpt != undefined && site[$(this).attr("sid")].callOpt.contentType != "") {
            var e = site[$(this).attr("sid")];
            $(".cTypeRadio").removeClass("active");
            var t = 0;
            $(".cTypeRadio").each(function() {
                if ($(this).text() == e.callOpt.contentType) {
                    $(this).addClass("active");
                    t = 1
                }
            });
    ...
    $("#checkNowAddons").live("click", function() {
        if ($(this).attr("register") == "no") {
            ...
            e["requiredData"] = {};
            e["requiredData"]["forceCheckUpdate"] = 1;
            doCall(ajaxCallPath, e, "checkIWPAddons", "json")
        }
    });
    ...
    $(".cc_addon_mask").live("click", function() {
        ...
        if ($(".cc_addon_img", this).hasClass("on")) {
            e["requiredData"]["deactivateAddons"] = {};
            e["requiredData"]["deactivateAddons"]["addons"] = {};
            e["requiredData"]["deactivateAddons"]["addons"][0] = {};
            e["requiredData"]["deactivateAddons"]["addons"][0]["slug"] = $(this).attr("addonslug");
            e["noGeneralCheck"] = 1
        } else {
            e["requiredData"]["activateAddons"] = {};
            e["requiredData"]["activateAddons"]["addons"] = {};
            e["requiredData"]["activateAddons"]["addons"][0] = {};
            e["requiredData"]["activateAddons"]["addons"][0]["slug"] = $(this).attr("addonslug");
            e["noGeneralCheck"] = 1
        }
        doCall(ajaxCallPath, e, "processAddonActivation");
        $(".cc_addon_img", this).toggleClass("on off");
        return false
    });
    $("#iwpAddonsBtn").live("click", function() {
        document.title = "SuperAdmin - Addons";
    ...
    $(".stopCall").live("click", function() {
        var e = {};
        e["requiredData"] = {};
        e["requiredData"]["getWaitData"] = {};
        e["requiredData"]["getWaitData"][$(this).attr("actionid")] = "sendData";
        doCall(ajaxCallPath, e, "")
    });
    $(".loginIWP").live("click", function() {
        ...
        var e = {};
        e["requiredData"] = {};
        e["requiredData"]["IWPAuthUser"] = {};
        if ($(this).hasClass("overwrite") && $(this).hasClass("yes")) {
            e["requiredData"]["IWPAuthUser"]["process"] = "changeRegister";
            e["requiredData"]["IWPAuthUser"]["username"] = usernameTemp;
            e["requiredData"]["IWPAuthUser"]["password"] = passwordTemp
        } else {
            $(".loginError").html("");
            ...
            e["requiredData"]["IWPAuthUser"]["username"] = usernameTemp;
            e["requiredData"]["IWPAuthUser"]["password"] = passwordTemp;
            e["requiredData"]["IWPAuthUser"]["login"] = "yes"
        }
        if ($(this).attr("actionvar") != undefined)
            e["requiredData"]["IWPAuthUser"]["action"] = $(this).attr("actionvar");
    ...
    $(".addToFavouritesBtn").live("click", function() {
        ...
        e["requiredData"] = {};
        var t = {};
        t["name"] = $(".dialog_cont #iname").val();
        t["URL"] = $(".dialog_cont #dlink").val();
        t["type"] = $(this).attr("utype");
        e["requiredData"]["addFavourites"] = {};
        e["requiredData"]["addFavourites"] = t;
        e["requiredData"]["getFavourites"] = 1;
        doCall(ajaxCallPath, e, "reloadFavouritesCustom", "json");
        $("#modalDiv").html();
        $("#modalDiv").dialog("close")
    });
    ...
    $(window).on("scroll", function() {
        ...
        if ($(".actionContent").is(":visible")) {
            var t = $(".actionContent").offset().top;
            distance = t - e;
            if (distance < 10) {
    ...
    $(".backupMechanism").live("mouseenter", function() {
        var e = $(this);
        if ($(this).hasClass("disabled")) {
            $(".tooltip_backup_method", e).show()
        }
    });
    $(".backupMechanism").live("mouseleave", function() {
        var e = $(this);
        if ($(this).hasClass("disabled")) {
            $(".tooltip_backup_method", e).hide()
        }
    });
    $(".tooltip_backup_method").live("mouseenter", function() {
        $(this).show()
    });
    $(".tooltip_backup_method").live("mouseleave", function() {
        $(this).hide()
    });
    $("#cron_activate_btn").live("click", function() {
        var e = $("#EasyCronApiToken").val();
        if (typeof e != "undefined" && e != "") {
            var t = {};
            t["requiredData"] = {};
            t["requiredData"]["manageEasyCron::activate"] = {};
            t["requiredData"]["manageEasyCron::activate"]["token"] = e;
            t["requiredData"]["manageEasyCron::isActive"] = {};
            t["requiredData"]["manageEasyCron::isActive"] = 1;
            t["requiredData"]["manageEasyCron::getTokenFromDB"] = {};
            t["requiredData"]["manageEasyCron::getTokenFromDB"] = 1;
            doCall(ajaxCallPath, t, "setEasyCronActivate")
        }
    });
    ...
    $("#cron_deactivate_btn").live("click", function() {
        var e = {};
        e["requiredData"] = {};
        e["requiredData"]["manageEasyCron::deactivate"] = {};
        e["requiredData"]["manageEasyCron::isActive"] = {};
        e["requiredData"]["manageEasyCron::getTokenFromDB"] = {};
        e["requiredData"]["manageEasyCron::isActive"] = 1;
        e["requiredData"]["manageEasyCron::deactivate"] = 1;
        e["requiredData"]["manageEasyCron::getTokenFromDB"] = 1;
        doCall(ajaxCallPath, e, "setEasyCronActivate")
    });
    ...
    $(".stop_multicall").live("click", function() {
        var e = {};
        e["requiredData"] = {};
        e["requiredData"]["terminateBackupMulticallProcess"] = {};
        e["requiredData"]["terminateBackupMulticallProcess"]["actionID"] = $(this).attr("actionID");
        doCall(ajaxCallPath, e, "");
        return false
    });
    $(".stop_multicall").live("mouseenter", function() {
        var e = $(this).closest(".in_progress");
        $(e).addClass("stopWarn");
        $(e).removeClass("in_progress")
    });
    $(".stop_multicall").live("mouseleave", function() {
        var e = $(this).closest(".stopWarn");
        $(e).removeClass("stopWarn");
        $(e).addClass("in_progress")
    });
    $(".tooltip_backup_method").live("mouseenter", function() {
    ...
    $(".download").live("click", function() {
        if ($(this).attr("href").indexOf("_iwp_part") >= 0) {
            var e = getFilesArrayFromIwpPart($(this).attr("href"));
            var t = $(this).closest(".row_backup_action");
            total_url_parts = -1;
            $.each(e, function(e, n) {
                $(".this_download_backup_" + e).remove();
                $(t).append('<a class="this_download_backup_' + e + '" style="dispaly:none" href="' + n + '" > </a>');
                total_url_parts += 1
            });
            $(this).attr("back_var", 0);
            $(this).attr("back_var_total", total_url_parts);
            var n = setInterval(function() {
                clickAnchor()
            }, 1e3);
            if (total_url_parts < 1) {
                total_url_parts = 1
            }
            setTimeout(function() {
                clearInterval(n)
            }, 1e3 * (total_url_parts + 3))
        }
    });
    $(".iwpServerInfo").live("click", function(e) {
        var t = new Array;
        t.push($(this).attr("sid"));
        var n = {};
        n["action"] = "backupTest";
        n["args"] = {};
        n["args"]["siteIDs"] = t;
        var r = {};
        r["iwpLoadServerInfo"] = $(this).attr("sid");
        n["requiredData"] = r;
        doCall(ajaxCallPath, n, "iwpLoadServerInfo", "json");
        return false
    });
    $(window).on("beforeunload", function(e) {
        if (typeof showBrowserCloseWarning != "undefined" && showBrowserCloseWarning) {
            return"A multi-call backup is under progress. Closing the window / logging out may result in error. Please wait till its completed."
        }
    });
    $(".onEnter").live("paste", function(e) {
        var t = $(this).attr("id");
        $(this).val("");
        $(this).clone().prependTo($(this).parent()).val("");
        setTimeout(function() {
            var n = $(e.target).val();
            $(".onEnter#" + t + ":last").remove();
            n = n.split("|^|");
            if (n.length > 1) {
                if (t == "readdAuthKey") {
                    $(".onEnter#readdAuthKey").val(n[2])
                } else {
                    $(".onEnter#adminURL").val(n[0]);
                    $(".onEnter#username").val(n[1]);
                    $(".onEnter#activationKey").val(n[2])
                }
            } else {
                $(".onEnter#" + t).val(n[0])
            }
    ...
    $("#maintenanceSiteConfirm").live("click", function() {
        var e = {};
        e["action"] = "iwpMaintenance";
        e["args"] = {};
        e["args"]["params"] = {};
        e["args"]["siteIDs"] = {};
        e["args"]["params"]["mcheck"] = $(".maintenanceRadio.active").attr("val");
        e["args"]["params"]["mHTML"] = $("#maintenanceHTML").val();
        e["args"]["siteIDs"][0] = $(this).attr("sid");
        e["requiredData"] = {};
        e["requiredData"]["iwpMaintenance"] = 1;
        doCall(ajaxCallPath, e, "processMaintenanceSite", "json", "none")
    });
    ...
    $(".edit_note").live("click", function() {
        var e = $(this).parent().parent().find(".site_notes");
        var t = $(this).closest(".site_flap_cont_data").attr("btsiteid");
        $('<textarea class="edit_site_notes">' + site[t]["notes"] + '</textarea><i class="save_note">Save Note</i>').insertAfter(e);
        e.hide();
        var n = $('.site_flap_cont_data[btsiteid="' + t + '"]');
        n.find(".edit_note").parent().css({height: $(".edit_site_notes").parent().height() + "px"});
        $(this).hide()
    });
    $(".edit_links").live("click", function() {
        var e = $(this).parent().parent().find(".site_links");
        var t = $(this).closest(".site_flap_cont_data").attr("btsiteid");
        $('<textarea class="edit_site_links" placeholder="separated by commas">' + site[t]["links"] + '</textarea><i class="save_links">Save Links</i>').insertAfter(e);
        e.hide();
        var n = $('.site_flap_cont_data[btsiteid="' + t + '"]');
        n.find(".edit_links").parent().css({height: $(".edit_site_links").parent().height() + "px"});
        $(this).hide()
    });
    $(".save_note").live("click", function() {
        var e = $(this).parent().parent().find(".edit_site_notes").val();
        var t = {};
        var n = {};
        n["siteID"] = $(this).closest(".site_flap_cont_data").attr("btsiteid");
        n["notes"] = e;
        t["requiredData"] = {};
        t["requiredData"]["iwpUpdateNotes"] = n;
        doCall(ajaxCallPath, t, "processUpdateNotes", "json", "none")
    });
    $(".save_links").live("click", function() {
        var e = $(this).parent().parent().find(".edit_site_links").val();
        var t = {};
        var n = {};
        n["siteID"] = $(this).closest(".site_flap_cont_data").attr("btsiteid");
        n["links"] = e;
        t["requiredData"] = {};
        t["requiredData"]["iwpUpdateLinks"] = n;
        doCall(ajaxCallPath, t, "processUpdateLinks", "json", "none")
    });
    ...
    $('#site_updates a').click(function (e) {
            e.preventDefault();
            $(this).tab('show');
    });
