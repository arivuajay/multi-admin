...
<div id="header_bar"> <div class="header_container"><a href="<?php echo APP_URL; ?>" style="text-decoration:none;">
    ...
    <a class="float-left fb_icon_hdr" href="//www.facebook.com/multiadmin" target="_blank"></a><a class="float-left twitter_icon_hdr" href="//twitter.com/multiadmin" target="_blank"></a>
    <ul id="header_nav">
      <!--<li><a href="">Suggest an Idea</a></li>-->
      <li><a class="updates_centre first-level" id="updateCentreBtn">MultiAdmin Update Centre<span id="updateCenterCount" style="display:none" class="count">1</span></a>
      ...
      <li><a class="first-level" id="iwpAddonsBtn">Addons <span class="count" style="<?php if(($addonUpdate = getAddonAlertCount()) < 1){ ?>display:none;<?php } ?>"><?php echo $addonUpdate; ?></span></a></li>
      ...
      <li class="help"><a class="first-level">Help <span style="font-size:7px;">â–¼</span></a>
      	<ul class="sub_menu_ul">
        	<li><a href="//arkinfotec.com/forum/" target="_blank">Discussion Forum</a></li>
    ...
    <div id="pageContent">
      <div class="empty_data_set welcome">
        ...
        <div class="line3">
          ...
          <span style="font-size:12px">(Before adding the website please install and activate MultiAdmin WP Client Plugin in your WordPress site)</span> </div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");
 ...
 Â  Â po.src = '//apis.google.com/js/plusone.js';
