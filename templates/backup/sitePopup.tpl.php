...
<div class="dialog_cont grid simple horizontal red view_backup">
  <div class="th rep_sprite grid-title">
    <h4 class="title droid700">BACKUPS - <?php echo $sitesData[$d['siteID']]['name'] ?></h4>
    <div class="tools">
    <a class="remove cancel rep_sprite_backup">&nbsp;</a>
    </div>
    </div>
    <div class=" modal-body grid-body" style="padding:20px;">
  <?php 
