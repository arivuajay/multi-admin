...
#
# manageEasyCron
# This Class is used to manage the EasyCron API with MultiAdmin Admin Panel
# Develope by : ARK Infotec Team
#
...
/*	public static function __construct(){
	...
	*/
	public static function activate($params){
		...
		self::$easyCronAPIObj->setOptions(array('cron_job_name' => 'MultiAdmin Task Cron'));
		...
		self::$easyCronAPIObj->setOptions(array('cron_job_name' => 'MultiAdmin Manage Cron'));
